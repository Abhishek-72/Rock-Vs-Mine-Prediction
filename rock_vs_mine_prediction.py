...
Original file is located at
    https://colab.research.google.com/drive/1D0y1lJ1oF2uD2DmYNngLaJyQplXKp8vL
"""
...
sonar_data.describe() ## describe the statistical measures of the dat
...
##Model traing will be using logistic  regression
